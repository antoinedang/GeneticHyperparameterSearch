...
def learn(populationSize = 50, populationElitismProportion = 0.2, dataset_type = "diabetes", mutation_prob = 10, dominant_gene = 1, genome_type = 2, fitness_loss_weight = 150, fitness_epoch_count_weight= 1, maxEpochsPerIndividual = 10000, max_patience = 100, max_evolutionary_patience = 20, max_evolutionary_steps= 100, experiment_name = "normal.csv", save_experiment_results = True):
    ...
    while num_evolutionary_steps < max_evolutionary_steps and current_evolutionary_patience <= max_evolutionary_patience:
        ...
        if save_experiment_results:
            ...
            appendToFile("experiment_results/" + experiment_name + "_score_distribution", str(population.population_fitness))
